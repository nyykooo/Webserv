...
/*   Updated: 2025/07/06 23:45:45 by ncampbel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// {
//     std::map<std::string, Server *>::iterator it;
//     std::map<std::string, Server *> servers_map = web->getServersMap();
//     for (it = servers_map.begin(); it != servers_map.end(); ++it)
//     {
...
// static void setClientTime(WebServer *web, int client_fd)
// {
//     std::vector<Client *>::iterator it;
//     std::vector<Client *> clientsVec = web->getClientsVec();

//     for (it = clientsVec.begin(); it != clientsVec.end(); ++it)
//     {
...
//         setClientTime(web, web->getEvents()[i].data.fd);
//     }
...
// static void lookForTimeouts(WebServer *web)
// {
//     std::vector<Client *>::iterator it;
//     std::vector<Client *> clientsVec = web->getClientsVec();    
//     for (it = clientsVec.begin(); it != clientsVec.end(); ++it)
...
//         if ((*it)->checkTimeout())
//         {
//             std::cout << "❌ Cliente desconectado por timeout - client_fd: " << (*it)->getSocketFd() << " ❌" << std::endl;
//             close((*it)->getSocketFd());
//             epoll_ctl(web->getEpollFd(), EPOLL_CTL_DEL, (*it)->getSocketFd(), NULL);
//             // delete *it;
//             clientsVec.erase(it); // Remove o cliente do vetor
